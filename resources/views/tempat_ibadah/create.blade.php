            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1">
                        ...
                        <x-input id="latitude" name="latitude" type="text" value="{{ old('latitude') }}" readonly class="bg-muted text-xs h-8" required />
                    </div>
                    <div class="space-y-1">
                        <x-label for="longitude" class="text-xs">Longitude</x-label>
                        <x-input id="longitude" name="longitude" type="text" value="{{ old('longitude') }}" readonly class="bg-muted text-xs h-8" required />
                    </div>
                </div>
            </div>
